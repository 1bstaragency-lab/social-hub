...
export default function AddAccountModal({ onClose, organizationId }) {
  ...
  const handleSCLoginSuccess = (data) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        {/* SoundCloud: use browser-based login form */}
        {platform === "soundcloud" ? (
          <div className="p-5">
            <SoundCloudLoginForm
              onSuccess={handleSCLoginSuccess}
              onError={(msg) => toast.error(msg)}
              onClose={onClose}
            />
          </div>
        ) : (
          /* Other platforms: standard credential form */
          <form onSubmit={handleSubmit} className="p-5 space-y-4">
            ...
            <details className="group">
              ...
              <div className="mt-2 space-y-2 pl-2 border-l-2 border-gray-100">
                <input
                  ...
                  value={proxy.server}
                  onChange={(e) =>
                    setProxy({ ...proxy, server: e.target.value })
                  }
            ...
            <div className="flex gap-2 pt-1">
              ...
              <button
                ...
                className="flex-1 py-2 text-sm bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition disabled:opacity-60"
              >
